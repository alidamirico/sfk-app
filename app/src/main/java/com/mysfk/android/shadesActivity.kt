...
class shadesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        radioGroup1 = findViewById(R.id.radioGroupS1)
        button1 = findViewById(R.id.sendButtonS1)
        ...
        val seekBar1 =findViewById<SeekBar>(R.id.seekBarS1)
        val textseekbar =findViewById<TextView>(R.id.showProgressS1)
        ...
        radioGroup2 = findViewById(R.id.radioGroupS2)
        button2 = findViewById(R.id.sendButtonS2)
        ...
        val seekBar2 =findViewById<SeekBar>(R.id.seekBarS2)
        val textseekbar2 =findViewById<TextView>(R.id.showProgressS2)
        ...
        radioGroup3 = findViewById(R.id.radioGroupS3)
        button3 = findViewById(R.id.sendButtonS3)
        ...
        val seekBar3 =findViewById<SeekBar>(R.id.seekBarS3)
        val textseekbar3 =findViewById<TextView>(R.id.showProgressS3)
        ...
        radioGroup4 = findViewById(R.id.radioGroupS4)
        button4 = findViewById(R.id.sendButtonS4)
        ...
        val seekBar4 =findViewById<SeekBar>(R.id.seekBarS4)
        val textseekbar4 =findViewById<TextView>(R.id.showProgressS4)
